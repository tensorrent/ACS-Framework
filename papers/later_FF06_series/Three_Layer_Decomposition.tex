...
\fancyhead[R]{\small TR-2026-FF06f}
\fancyfoot[C]{\thepage}
...
\date{\small Companion to TR-2026-FF06b' and TR-2026-FF06e \ ---\ SIP License v1.1}
...
\small Accompanies TR-2026-FF06b' (\emph{Spectral Witness Survival}) and TR-2026-FF06e (\emph{Form, Function, and the Shuffle Knife}). SIP License v1.1.
