...
\fancyhead[R]{\small\color{acsslate}\texttt{TR-2026-FF06d}}
...
\vspace{6pt}
\noindent{\footnotesize\color{acsslate}\hfill\texttt{TR-2026-FF06d} \quad|\quad \textit{Architectural PDR} \quad|\quad April 2026}
\vspace{6pt}
\noindent{\color{acsrule}\rule{\textwidth}{0.4pt}}
\vfill
\begin{center}
...
\item
  \textbf{Document ID.} TR-2026-FF06d
\end{itemize}
