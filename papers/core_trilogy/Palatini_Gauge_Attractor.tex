...
\fancyhead[R]{\small\color{acsslate}\textit{Colour from Gravity}}
...
\author{Bradley Wallace\\[0.3em]
        \small \textit{Independent Researcher}\\[0.2em]
        \small \texttt{Colour from Gravity}}
...
\vspace{6pt}
\noindent{\footnotesize\color{acsslate}\hfill\textit{Colour from Gravity} \quad|\quad \textit{Independent Research} \quad|\quad March 2026}
\vspace{6pt}
\noindent{\color{acsrule}\rule{\textwidth}{0.4pt}}
