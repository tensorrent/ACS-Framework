...
Equation~\eqref{eq:alpha} is a numerical output of the capacitance model
with the matching condition~\eqref{eq:Ecap}.  It is sensitive to the
precise logarithmic cutoff and to the factor $e/2$ assignment.  It is
reported as an as-implemented estimate, not as a uniqueness theorem for
$\alpha$.
\end{remark}
